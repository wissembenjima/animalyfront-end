...
import com.example.animaly.activities.*
...
class ProfilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adresse_btn = root.findViewById<Button>(R.id.adresse_btn)
        adresse_btn.setOnClickListener {
            val intent = Intent(root.context, AdresseActivity::class.java)
            intent.putExtra("from","profil")
            startActivity(intent)
        }

        val paiement_btn = root.findViewById<Button>(R.id.paiement_btn)
        paiement_btn.setOnClickListener {
            val intent = Intent(root.context, PaiementActivity::class.java)
            startActivity(intent)
        }

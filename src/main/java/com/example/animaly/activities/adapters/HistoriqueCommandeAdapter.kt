...
class HistoriqueCommandeAdapter(private val dataSet: ArrayList<CommandeItem>) :
    RecyclerView.Adapter<HistoriqueCommandeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.historique_commande_item, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val totalTxt = "${dataSet[position].total} DT"
        viewHolder.countTextView.text = totalTxt
